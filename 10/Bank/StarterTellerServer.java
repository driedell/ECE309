...
public class StarterTellerServer extends UnicastRemoteObject implements	TellerInterface {

	public static void main(String[] args) {
		
		try {
			new StarterTellerServer();
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	
	public StarterTellerServer() throws Exception {
		super();
