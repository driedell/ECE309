...
public class PictureChatServer implements Runnable {
	...
	ConcurrentHashMap<String,Vector<String>> savedMessages = new ConcurrentHashMap<String,Vector<String>>();
	...
	public PictureChatServer() throws IOException {
		...
		try {
			ObjectInputStream ois = new ObjectInputStream(new FileInputStream("SavedMessages.ser"));
	...
	public void run() { // app threads enter here
		...
		try {
			...
			System.out.println("Client has connected from "	+ s.getInetAddress());
