...
public class TellerClient implements ActionListener {
	public static void main(String[] args) {
		...
		try {
			new TellerClient(serverAddress, serverAppName);
		} catch (Exception e) {
	...
	public TellerClient(String serverAddress, String serverAppName) throws Exception {
		...
		this.showByNumberButton.setForeground(Color.red);
		this.showByNameButton.setForeground(Color.red);
	...
	private void processAccount(String processType) throws IllegalArgumentException, RemoteException {
		...
		if(processType.equals(Bank.CLOSE)) {
			...
			this.displayTextArea.setText(this.server.closeAccount(accountNumber, customerName));
		}
	}
